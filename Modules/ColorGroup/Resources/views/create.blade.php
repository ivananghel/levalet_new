...
<div class="modal-body no-padding" >
    ...
    <form action="{{ route('colorgroup.store') }}" id="add-color-form" method="post" class="smart-form">
            ...
            <div class="row">
                <section class="col col-9">
                    ...
                    <label class="input"> <i class="icon-append fa fa-file-text-o "></i>
                        <input type="text" name="title" required placeholder="{{ trans('colorgroup::lang.label_title') }}">
                    </label>
                </section>
                <section class="col col-3">
                    <label class="label">{{ trans('colorgroup::lang.status') }}</label>
                    <span class="onoffswitch " >
                        <input id="plo" class="onoffswitch-checkbox" name="status" type="checkbox">
            ...
            <div class="row groupcolor" id="color_update">
                <div class ="countcolor">
                    <section class="col col-5" >
                        ...
                        <label class="input"> <i class="icon-append fa fa-file-text-o "></i>
                            <input   type="text" name="group[0][name]" placeholder="{{ trans('colorgroup::lang.name') }}" required>
                        </label>
                    ...
                    <section class="col col-4" >
                        ...
                        <label class="input"> <i class="icon-append fa fa-pencil-square   "></i>
                            <input  class="color-pick"  data-color="#6D2781" type="text" name="group[0][color]" required>
                        </label>
